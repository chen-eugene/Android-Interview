...
#### [2、Android内存管理机制（LowMemoryKiller）。](http://gityuan.com/2015/10/01/process-lifecycle/)
...
#### [2、内存泄漏如何产生，常见的Android内存泄漏的场景，怎么解决。](https://yq.aliyun.com/articles/3009)
...
#### [6、Bitmap使用的时候注意什么（Bitmap优化）。](https://www.jianshu.com/p/e49ec7d053b3)
...
#### [8、WebView的泄露如何解决。](https://lipeng1667.github.io/2016/08/06/memory-optimisation-for-webview-in-android/)
