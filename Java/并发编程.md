...
#### [14、一个线程发生异常会怎么样（Thread.UncaughtExceptionHandler原理）。](https://juejin.im/post/5b598e7a5188251aaa2d3901)
...
#### [16、锁的等级：方法锁、对象锁、类锁。](https://blog.csdn.net/qq_35181209/article/details/72627363)
...
#### [17、ThreadLocal的设计理念与作用，ThreadPool用法与优势（AsyncTask底层有使用）。](https://www.cnblogs.com/hadoop-dev/p/7092935.html)
